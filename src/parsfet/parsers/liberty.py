...
class LibertyParser(BaseParser[LibertyLibrary]):
    ...
    def _build_lut(self, grp: dict, templates: dict) -> Optional[LookupTable]:
        ...
        # Parse indices
        idx1 = self._extract_index(attrs.get("index_1")) or self._extract_index(template.get("index_1"))
        idx2 = self._extract_index(attrs.get("index_2")) or self._extract_index(template.get("index_2"))
