...
class LegacyLEFParser(BaseParser[LEFLibrary]):
    """Legacy LEF parser using regex-based tokenization.

    This is the original parser implementation, kept for reference and comparison.
    For new code, use LEFParser (Lark-based) instead.
    """
...
class LegacyTechLEFParser(BaseParser[TechLEF]):
    """Legacy TechLEF parser using regex-based tokenization.

    This is the original parser implementation, kept for reference and comparison.
    For new code, use TechLEFParser (Lark-based) instead.
    """

    def __init__(self):
        """Initializes the LegacyTechLEFParser."""
        self._lef_parser = LegacyLEFParser()
